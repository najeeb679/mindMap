  ...
  return (
    ...
    >
      ...
      <Box width={{ md: "90%", sm: "100%" }} marginX={{ md: "auto", sm: "none" }} className="slider-container">
        <Slider {...settings}>
          {SliderData.map((item) => (
            <Card sx={{ backgroundColor: COLOR.lightOrange, boxShadow: "none" }}>
              <CardMedia
                sx={{
                ...
                title={item.Name}
              />
              <CardContent sx={{ textAlign: "center", width: { md: 240, sm: 200, xs: 100 }, marginX: "auto", color: COLOR.white }}>
                <Typography variant="body2" fontSize={{ md: 16, sm: 13, xs: 6 }}>
                  {item.text}
                </Typography>
